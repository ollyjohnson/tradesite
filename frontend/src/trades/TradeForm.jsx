  ...
  return (
    <div className="challenge-container">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <label>Mistake</label>
        <input value={mistake} onChange={e => setTicker(e.target.value)} required />
        ...
        {buys.map((buy, i) => (
          <div key={i}>
            ...
            <input type="number" value={commissions} placeholder="Commissions" onChange={e => handleChange(commissions, setBuys, i, "commissions", e.target.value)} required />
          </div>
        ))}
        ...
        {sells.map((sell, i) => (
          <div key={i}>
            ...
            <input type="number" value={commissions} placeholder="Commissions" onChange={e => handleChange(commissions, setSells, i, "commissions", e.target.value)} required />
          </div>
        ))}
